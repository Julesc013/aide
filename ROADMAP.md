...
- review Q28 Git Workflow Policy v0 evidence
- implement Q29 Merge / Land / Promote Helper v0 as safe dry-run-first helpers, with live AIDE branch mutation still forbidden during implementation
