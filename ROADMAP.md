...
- review Q29 Merge / Land / Promote Helper v0 evidence
- implement Q30 AIDE Dev/Main Policy Sync to decide and apply AIDE-specific `dev`/`main` posture if appropriate
