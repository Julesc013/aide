...
- review the Eureka and Dominium import pilot evidence in their target repos
- run a post-pilot AIDE checkpoint/import-scope refinement so AIDE docs and import tooling reflect target-repo evidence
