...
- run Q41 Existing Tool Absorption v0 after Q40 so existing tool roots can be inventoried and wrapped through reviewed dry-run plans before any future migration or apply phase
