...
- run Q40 Root Recycling Framework v0 after Q39 so root-level cleanup can classify, preserve, wrap, adapt, extract, or alias candidates through reviewed dry-run plans before any future apply phase
