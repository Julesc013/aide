...
- run a post-Q24 checkpoint audit to verify adapter compiler, export-pack, and docs state
- reconcile or run real Q22 Eureka Import Pilot and Q23 Dominium Import Pilot evidence in target repos before claiming cross-repo adapter value
