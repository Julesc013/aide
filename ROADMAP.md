...
- review QFIX-01 and then run QFIX-02 AIDE Lite Test Discovery and Runner Fix
- start Q21 Cross-Repo Pack Export / Import v0 only after QFIX-02
- run Q22 Eureka Import Pilot and Q23 Dominium Import Pilot before tool-adapter expansion
- defer Q24 Existing Tool Adapter Compiler v0 until export/import pilots prove the compact pack can help real external repos
