...
- review Q30 AIDE Dev/Main Policy Sync evidence
- implement Q31 Export Pack Sync for Git/Commit Workflow so generic commit and Git workflow policies are safely propagated without exporting AIDE-specific live branch state
