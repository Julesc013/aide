...
| `Q02-structural-skeleton` | Add the smallest filesystem skeleton for Contract, Harness, Compatibility, and Dominium Bridge. | needs review after Q02 implementation |
