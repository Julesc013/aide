...
| `Q12-verifier-v0` | Verifier v0 | Add mechanical checks for evidence packets, file refs, generated drift, forbidden paths, and diff scope. | recommended next; not implemented |
