...
KIND_RULES = {
    "HostManifest": {
        ...
        "required_spec": {"host_id", "host_kind", "repository_identity", "selected_revision", "supported_surfaces"},
    },
    "HostCapabilitySet": {
        "semantic_owner": "AIDE",
        "identity_owner": "AIDE",
    ...
    "WorkspaceDescriptor": {
        ...
        "required_spec": {"workspace_ref", "selected_revision", "branch", "identity_is_file_path", "local_path_is_locator_only"},
    },
    "ContextDescriptor": {
        "semantic_owner": "AIDE",
        "identity_owner": "AIDE",
        "authority_role": "bounded_context_projection",
        "required_spec": {"context_ref", "artifact_refs", "section_count", "sections", "source_revision_binding"},
    },
    "ArtifactReference": {
        "semantic_owner": "Dominium",
        "identity_owner": "AIDE",
        "authority_role": "artifact_reference_to_dominium_source_bytes",
        "required_spec": {"artifact_ref", "source_path", "source_role", "authority", "sha256", "source_revision"},
    },
    "DiagnosticProjection": {
        "semantic_owner": "Dominium",
        "identity_owner": "AIDE",
        "authority_role": "read_only_projection_of_dominium_diagnostic_contract",
        "required_spec": {"diagnostic_id", "code", "severity", "category", "summary", "severity_valid", "source_registry_path"},
    },
    "RefusalProjection": {
        "semantic_owner": "Dominium",
        "identity_owner": "AIDE",
        "authority_role": "read_only_projection_of_dominium_refusal_contract",
        "required_spec": {"refusal_id", "code", "category", "summary", "reason", "recovery", "source_registry_path"},
    },
    ...
    "EventEnvelope": {
        ...
        "required_spec": {"event_ref", "event_type", "sequence", "causation_ref", "correlation_ref", "universal_event_store_implemented"},
    },
    "DominiumBridgeManifest": {
        "semantic_owner": "AIDE",
        "identity_owner": "AIDE",
        "authority_role": "mapping_version_law_projection",
        "required_spec": {"bridge_id", "bridge_runtime_implemented", "mapping_version", "source_revision", "source_of_truth", "ownership", "command_mapping", "compatibility_policy"},
    },
}
