...
- Checkpoint and repair docs under `.aide/queue/QCHECK-token-survival-foundation-audit/**` and `.aide/queue/QFIX-01-foundation-review-reconciliation/**` record the post-Q09-Q20 audit and reconciliation baseline. QFIX-01 accepts Q09-Q20 with notes while preserving QFIX-02 test discovery, cross-repo import, exact tokenizer, provider billing, live Gateway/provider, and arbitrary coding-quality evidence as future work.
