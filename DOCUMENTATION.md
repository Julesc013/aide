...
- `.aide/policies/export-import.yaml`, `.aide/export/aide-lite-pack-v0/**`, `.aide/import/**`, `.aide/queue/Q21-cross-repo-pack-export-import-v0/**`, and `.aide/queue/Q25-importer-scope-and-state-truth-repair/**`: Q21 portable AIDE Lite Pack policy, generated pack, target import templates, Q25 pack integrity/import scope repair evidence, fixture validation evidence, and review-gated queue packets.
