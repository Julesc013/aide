...
- Token-survival, context, verifier, and evidence-review docs under `.aide/policies/token-budget.yaml`, `.aide/policies/verification.yaml`, `.aide/prompts/**`, `.aide/memory/**`, `.aide/context/**`, `.aide/verification/**`, `.aide/scripts/aide_lite.py`, `docs/reference/token-survival-core.md`, `docs/reference/aide-lite.md`, `docs/reference/context-compiler-v0.md`, `docs/reference/verifier-v0.md`, and `docs/reference/evidence-review-workflow.md` define Q09 compact packets, Q10 deterministic AIDE Lite behavior, Q11 repo-map/test-map/context-packet behavior, Q12 mechanical verifier behavior, and Q13 compact review-packet behavior.
...
- `.aide/scripts/aide_lite.py`: Q13-extended standard-library token-survival/context/verifier/review helper for doctor, validate, estimate, snapshot, index, context, map, pack, verify, review-pack, adapt, and selftest.
- `.aide/scripts/tests/test_aide_lite.py`, `.aide/scripts/tests/test_verifier.py`, and `.aide/scripts/tests/test_review_pack.py`: no-install workflow tests for AIDE Lite token, context, verifier, and review-packet behavior.
