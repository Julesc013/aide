...
- Token-survival, context, verifier, evidence-review, token-ledger, and golden-task docs under `.aide/policies/token-budget.yaml`, `.aide/policies/token-ledger.yaml`, `.aide/policies/verification.yaml`, `.aide/policies/evals.yaml`, `.aide/prompts/**`, `.aide/memory/**`, `.aide/context/**`, `.aide/reports/**`, `.aide/verification/**`, `.aide/evals/**`, `.aide/scripts/aide_lite.py`, `docs/reference/token-survival-core.md`, `docs/reference/aide-lite.md`, `docs/reference/context-compiler-v0.md`, `docs/reference/verifier-v0.md`, `docs/reference/evidence-review-workflow.md`, `docs/reference/token-ledger.md`, and `docs/reference/golden-tasks-v0.md` define Q09 compact packets, Q10 deterministic AIDE Lite behavior, Q11 repo-map/test-map/context-packet behavior, Q12 mechanical verifier behavior, Q13 compact review-packet behavior, Q14 estimated token accounting, and Q15 deterministic local golden tasks.
...
- `.aide/scripts/aide_lite.py`: Q15-extended standard-library token-survival/context/verifier/review/ledger/eval helper for doctor, validate, estimate, snapshot, index, context, map, pack, verify, review-pack, ledger scan/add/report/compare, eval list/run/report, adapt, and selftest.
- `.aide/scripts/tests/test_aide_lite.py`, `.aide/scripts/tests/test_verifier.py`, `.aide/scripts/tests/test_review_pack.py`, `.aide/scripts/tests/test_token_ledger.py`, and `.aide/scripts/tests/test_golden_tasks.py`: no-install workflow tests for AIDE Lite token, context, verifier, review-packet, token-ledger, and golden-task behavior.
