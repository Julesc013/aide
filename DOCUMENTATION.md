...
- Release bundle docs under `.aide/policies/release*.yaml`, `.aide/release/**`, `.aide/queue/Q47-aide-lite-release-bundle-v0/**`, and `docs/reference/aide-lite-release-bundle.md` define Q47 deterministic local bundle generation, archive checksums, manifests, install notes, provenance, and fixture extraction validation without Git tags, GitHub Releases, uploads, branch mutation, active CI installation, target installs, provider/model/network calls, or publication.
