...
LANE_PROOF = {
    "lane_id": "microsoft.visual-studio-mac.companion",
    "proof_kind": "runnable-fallback",
    "execution_mode": "cli-bridge",
    "boot_slice_notes": "P11 companion fallback proof. Shared-core behavior is reused through a thin cli-bridge wrapper; the native MonoDevelop-derived lane remains blocked.",
    "capability_notes": "P11 lane-local capability report for the runnable companion fallback proof. Native Visual Studio for Mac add-in loading remains blocked.",
    "top_level_notes": "Lane-local cli-bridge boot-slice proof completed with deterministic report output.",
}


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AIDE boot-slice proof for the Visual Studio for Mac companion lane.")
