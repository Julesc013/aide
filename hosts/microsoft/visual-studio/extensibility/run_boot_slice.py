...
LANE_PROOF = {
    "lane_id": "microsoft.visual-studio.extensibility",
    "proof_kind": "degraded-runnable",
    "execution_mode": "cli-bridge",
    "boot_slice_notes": "P11 degraded lane proof. Shared-core behavior is reused through a thin cli-bridge wrapper; richer out-of-process or local-service integration remains deferred.",
    "capability_notes": "P11 lane-local capability report for a degraded cli-bridge proof. The documented local-service execution shape remains deferred.",
    "top_level_notes": "Lane-local cli-bridge boot-slice proof completed with deterministic report output.",
}


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AIDE boot-slice proof for the Visual Studio Extensibility lane.")
