...
LANE_PROOF = {
    "lane_id": "microsoft.visual-studio.com-addin",
    "proof_kind": "degraded-runnable",
    "execution_mode": "cli-bridge",
    "boot_slice_notes": "P11 degraded lane proof. Shared-core behavior is reused through a thin cli-bridge wrapper; native COM add-in loading remains blocked.",
    "capability_notes": "P11 lane-local capability report for a degraded cli-bridge proof. Native COM add-in loading and editor wiring remain blocked.",
    "top_level_notes": "Lane-local cli-bridge boot-slice proof completed with deterministic report output.",
}


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AIDE boot-slice proof for the Visual Studio COM add-in lane.")
