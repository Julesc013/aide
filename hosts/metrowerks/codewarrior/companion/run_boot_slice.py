...
LANE_PROOF = {
    "lane_id": "metrowerks.codewarrior.companion",
    "proof_kind": "runnable-fallback",
    "execution_mode": "cli-bridge",
    "boot_slice_notes": "P13 companion fallback proof. Shared-core behavior is reused through a thin cli-bridge wrapper; this lane covers unresolved or non-native CodeWarrior workflows outside the archival-native ide-sdk proof.",
    "capability_notes": "P13 lane-local capability report for the runnable CodeWarrior companion fallback proof. Native archival SDK loading remains environment-bound, and broader project-aware workflows remain deferred.",
    "top_level_notes": "Lane-local cli-bridge boot-slice proof completed with deterministic report output.",
}


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AIDE boot-slice proof for the CodeWarrior companion lane.")
