...
LANE_PROOF = {
    "lane_id": "apple.xcode.companion",
    "proof_kind": "runnable-fallback",
    "execution_mode": "cli-bridge",
    "boot_slice_notes": "P12 companion fallback proof. Shared-core behavior is reused through a thin cli-bridge wrapper; the native XcodeKit lane remains blocked.",
    "capability_notes": "P12 lane-local capability report for the runnable Apple companion fallback proof. Native XcodeKit proof remains blocked in the current environment.",
    "top_level_notes": "Lane-local cli-bridge boot-slice proof completed with deterministic report output.",
}


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AIDE boot-slice proof for the Xcode companion lane.")
