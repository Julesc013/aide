...
- queue, ExecPlan, and review skills for filesystem-routed self-hosting work
...
- `.aide/queue/` defines the canonical filesystem queue for non-trivial self-hosting work.
