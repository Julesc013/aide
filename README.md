...
- Q34 Changelog and Release Notes Generator v0 is implemented and awaiting review. It compiles structured commits into preview-only changelog and release-note Markdown/JSON drafts, reports malformed history, adds Q34 golden tasks and tests, and keeps tags, GitHub Releases, branch mutation, and publishing deferred.
