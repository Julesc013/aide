...
title: "minimal_contract_envelope"
description: "Accepted capability summary for minimal_contract_envelope."
resource: "aide://capability/minimal_contract_envelope"
tags:
  - "aide"
  - "capability"
  - "envelope"
timestamp: "2026-06-17T00:00:00+10:00"
aide_uri: "aide://capability/minimal_contract_envelope"
...
This capability page summarizes `minimal_contract_envelope` from queue and report evidence. It does not create or accept capability by itself.

## Accepted Scope

- Accepted status: `accepted_with_warnings`
- Protocol page: [../protocol/envelope.md](../protocol/envelope.md)
