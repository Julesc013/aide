...
- The live Task OS `latest_task_id` remains stale relative to the accepted ReferenceID queue truth.
- The next task must be `AIDE-CHECK-EVENT-RECORD-SCHEMA-01`, not OKF.
