...
py -3 .aide/scripts/aide_lite.py task inspect --task-id AIDE-BUILD-OWNERSHIP-LEDGER-V1-REPAIR-01
py -3 .aide/scripts/aide_lite.py task evidence --task-id AIDE-BUILD-OWNERSHIP-LEDGER-V1-REPAIR-01
git diff --check
