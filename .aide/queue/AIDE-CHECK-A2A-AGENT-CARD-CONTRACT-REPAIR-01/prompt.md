...
Check `AIDE-BUILD-A2A-AGENT-CARD-CONTRACT-REPAIR-01` without modifying A2A implementation, schema, tests, fixtures, generated reports, repair reports, or failed-check evidence.
