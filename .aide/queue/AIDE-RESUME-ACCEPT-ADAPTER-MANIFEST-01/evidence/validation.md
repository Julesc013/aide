...
py -3 .aide/scripts/aide_lite.py task inspect --task-id AIDE-RESUME-CHECK-ADAPTER-MANIFEST-01
py -3 .aide/scripts/aide_lite.py task evidence --task-id AIDE-RESUME-CHECK-ADAPTER-MANIFEST-01
py -3 .aide/scripts/aide_lite.py validate
```

Final results are recorded before commit.
...
- acceptance task inspect/evidence: complete with `missing_evidence: 0`.
- `aide_lite.py validate`: `PASS`.
- JSON parse for acceptance JSON reports: passed.
