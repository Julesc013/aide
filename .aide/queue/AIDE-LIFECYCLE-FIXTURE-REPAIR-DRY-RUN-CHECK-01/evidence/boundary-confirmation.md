...
- review-gated report-only repair dry-run checkpoint only
- no production-ready or release-ready claim

Required boundary wording:

- managed section evidence is review-only
- missing marker evidence remains blocked before apply
- malformed marker evidence remains blocked before apply
