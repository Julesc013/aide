...
| `py -3 .aide/scripts/aide_lite.py roots inventory` | PASS | 22 roots, 1,751 files, no-apply true. |
| `py -3 .aide/scripts/aide_lite.py roots classify` | PASS | 22 roots, 1,751 files, 1,695 review-required file classifications, no-apply true. |
...
| `py -3 .aide/scripts/aide_lite.py roots status` | PASS | 22 roots, 3 mixed roots, 22 unknown-owner root candidates, 15 high-risk roots, fate counts `keep=1374`, `unknown=377`. |
