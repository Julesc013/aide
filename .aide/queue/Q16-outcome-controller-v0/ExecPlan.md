...
- [x] Extend AIDE Lite with outcome report/add and optimize suggest behavior.
- [x] Add tests for signal readers, outcome records, recommendations, and selftest integration.
- [x] Generate latest outcome report, recommendations, Q17 task packet, review packet, and token summary.
