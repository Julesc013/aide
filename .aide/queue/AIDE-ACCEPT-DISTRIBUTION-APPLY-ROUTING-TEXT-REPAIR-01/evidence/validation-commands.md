...
- `py -3 .aide/scripts/aide_lite.py task inspect --task-id AIDE-ACCEPT-DISTRIBUTION-APPLY-ROUTING-TEXT-REPAIR-01`
- `py -3 .aide/scripts/aide_lite.py task evidence --task-id AIDE-ACCEPT-DISTRIBUTION-APPLY-ROUTING-TEXT-REPAIR-01`
- `git diff --name-only -- .aide/fixtures/aide-self-consumer-fixture-v0 .aide/scripts/aide_lite.py .aide/scripts/tests/test_aide_distribution_apply_routing_text_repair.py .aide/scripts/tests/test_aide_self_consumer_fixture_v0 core/distribution`
- path safety scan
