...
- Path safety scan: changed paths are limited to this acceptance task packet, this acceptance report, `.aide/queue/index.yaml`, `PLANS.md`, and `IMPLEMENT.md`.
...
- Overclaim scan: `current.json`, `current.md`, and acceptance reports preserve false/not-ready readiness for blocked product surfaces.
