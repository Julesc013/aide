...
| `py -3 .aide/scripts/aide_lite.py distribution-product status` | PASS_WITH_WARNINGS, read-only projection output |
...
| `py -3 .aide/scripts/aide_lite.py task inspect --task-id AIDE-ACCEPT-DISTRIBUTION-PRODUCT-STATUS-PROJECTION-01` | PASS, missing evidence 0 |
| `py -3 .aide/scripts/aide_lite.py task evidence --task-id AIDE-ACCEPT-DISTRIBUTION-PRODUCT-STATUS-PROJECTION-01` | PASS, missing none |
