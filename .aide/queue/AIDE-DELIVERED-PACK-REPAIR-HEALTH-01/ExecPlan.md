...
- [x] Independently rereview the CRLF repair; it received source
      ACCEPT_WITH_NOTES. The combined `99a9e54d` source, 100-case suite,
      generated ZIP/tar and 25-command consumer canary passed scoped review.
      See `evidence/combined-qualification-99a9e54d.md`.
- [x] Commit generated bytes, prove the bounded four-command derived replay,
      obtain exact dev-effect review and observe remote `dev@54b9d45e`.
      See `evidence/dev-integration.md`. Parent stable-release gates stay open.
