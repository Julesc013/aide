...
`rg -n "(?i)(api[_-]?key|secret|password|token|credential|private[_-]?key)" .aide/queue/AIDE-LIFECYCLE-FIXTURE-APPLY-GATE-01 .aide/reports/lifecycle-fixture-apply-gate`
