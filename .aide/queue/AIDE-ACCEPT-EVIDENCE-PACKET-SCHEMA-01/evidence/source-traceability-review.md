...
- Projection metadata includes source paths.
- Artifact references exist.
- Artifact hashes match observed files.
- Claims are supported by source fields or accepted prior slice status.
- Packets do not rely on conversational memory as evidence.
