...
| 3 | `.aide/release/dist/aide-lite-pack-v0.checksums.json` | checksums | 1132 | `0cc9f37bad932cc4...` | true |
| 4 | `.aide/release/dist/SHA256SUMS.txt` | sha256sums_text | 604 | `e5cee7b9d066d5de...` | true |
| 5 | `.aide/release/dist/manifest.yaml` | manifest | 1406 | `f1d9297f1f86512f...` | true |
| 6 | `.aide/release/dist/install.md` | install_notes | 2418 | `95a75c1019c749ae...` | true |
| 7 | `.aide/release/dist/CHANGELOG.preview.md` | changelog_preview_copy | 7859 | `a3e381d574a01ad3...` | true |
| 8 | `.aide/release/dist/RELEASE_NOTES.preview.md` | release_notes_preview_copy | 5295 | `f38f9e4132d301b4...` | true |
...
| 11 | `.aide/release/dist/release-provenance.json` | provenance_report | 1448 | `51f5109283986246...` | false |
| 12 | `.aide/release/dist/release-assets.json` | asset_index | 4080 | `64af89003a2dad27...` | false |
