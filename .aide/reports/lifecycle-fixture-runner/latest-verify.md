...
- PASS: negative capability labels are explicit (active_repo_apply,target_repo_apply,general_lifecycle_apply,rollback_execution,uninstall_execution,release_ready,production_ready)
