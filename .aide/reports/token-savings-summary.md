...
- `.aide/context/latest-review-packet.md`: 8387 chars / 2097 approx tokens / near_budget
...
- `token_survival_baseline`: 18588 chars / 4647 approx tokens
...
- `.aide/context/latest-review-packet.md` vs `review_baseline`: 70.0% estimated reduction (2097 vs 6995 approx tokens)
...
- `.aide/context/latest-review-packet.md` (review_packet): 2097 approx tokens
...
- near budget: review_packet `.aide/context/latest-review-packet.md` 2097/2400
