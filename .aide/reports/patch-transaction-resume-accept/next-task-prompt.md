...
PatchTransaction acceptance has resumed. The slice should define declaration and
inspection of adapter integration shape only. It must not admit, trust, execute,
launch, schedule, sandbox, call providers, call network services, mutate GitHub,
create branches/worktrees, apply patches, mutate target repositories, or build
runtime behavior.
