...
- remove_portable_file_future: .aide/adapters/templates/AGENTS.md.template (remove_portable_file_future)
- remove_portable_file_future: .aide/adapters/templates/CLAUDE.md.template (remove_portable_file_future)
- remove_portable_file_future: .aide/adapters/templates/aider.conf.yml.template (remove_portable_file_future)
- remove_portable_file_future: .aide/adapters/templates/clinerules.template (remove_portable_file_future)
- remove_portable_file_future: .aide/adapters/templates/continue-checks.template.md (remove_portable_file_future)
- remove_portable_file_future: .aide/adapters/templates/cursor-rule.template.md (remove_portable_file_future)
- remove_portable_file_future: .aide/adapters/templates/windsurf-rule.template.md (remove_portable_file_future)
...
- remove_portable_file_future: .aide/commands/catalog.yaml (remove_portable_file_future)
